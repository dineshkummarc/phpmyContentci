...
import com.inw24.content.fragments.WebViewFragment;
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (thePosition == 6) //Privacy Policy and Terms
                    {
                        ...
                        String theTitle = context.getString(R.string.about_app_terms);
                        ...
                        ((FragmentActivity)context).getSupportFragmentManager().beginTransaction()
                                ...
                                .addToBackStack(null)
                                .commit();
                    }else if (thePosition == 9) { //Developer Website
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(context.getString(R.string.app_website)));
                        ...
                        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:" + context.getString(R.string.app_email)));
                    ...
                    }else if (thePosition == 7) { //Privacy Policy
                        WebViewFragment webViewFragmentAbout = new WebViewFragment();
                        //Pass variable to fragment
                        Bundle bundle = new Bundle();
