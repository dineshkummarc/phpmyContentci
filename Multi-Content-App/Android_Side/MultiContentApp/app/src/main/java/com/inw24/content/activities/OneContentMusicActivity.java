...
public class OneContentMusicActivity extends AppCompatActivity {
    ...
    FloatingActionButton floatingActionButtonShowMusic;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        coordinatorLayoutOneContentMusic = (CoordinatorLayout) findViewById(R.id.coordinatorLayoutOneContentMusic);
        ...
        Glide
            .with(OneContentMusicActivity.this)
        ...
        if (mobileUserLogin != null) {
            ...
            floatingActionButtonBookmark.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Snackbar snackbar = Snackbar.make(coordinatorLayoutOneContentMusic, R.string.txt_please_login_first, Snackbar.LENGTH_LONG)
                            .setAction(R.string.txt_bookmark_login, new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    startActivity(new Intent(OneContentMusicActivity.this, LoginActivity.class));
                                }
                            });
        ...
        /*floatingActionButtonShowMusic = (FloatingActionButton) findViewById(R.id.fabShowVideo);
        floatingActionButtonShowMusic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        showContent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(contentTypeId.equals("7") || contentTypeId.equals("8"))
                {
                    //Go to browser
                ...
                try
                {
                    for (int i = 0; i < response.length(); i++)
                    {
                        ...
                        if(contentUrl.equals(""))
                        {
                            ...
                            floatingActionButtonShowMusic.setVisibility(View.GONE);
                        }
