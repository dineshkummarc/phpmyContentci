...
import static com.inw24.content.Config.DIRECTION;

public class OneContentTextActivity extends AppCompatActivity {
    ...
    FloatingActionButton floatingActionButtonShowText;
    CoordinatorLayout coordinatorLayoutOneContentText;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        coordinatorLayoutOneContentText = (CoordinatorLayout) findViewById(R.id.coordinatorLayoutOneContentText);
        ...
        Glide
            .with(OneContentTextActivity.this)
        ...
        if (mobileUserLogin != null) {
            ...
            floatingActionButtonBookmark.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Snackbar snackbar = Snackbar.make(coordinatorLayoutOneContentText, R.string.txt_please_login_first, Snackbar.LENGTH_LONG)
                            .setAction(R.string.txt_bookmark_login, new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    startActivity(new Intent(OneContentTextActivity.this, LoginActivity.class));
                                }
                            });
        ...
        floatingActionButtonShowText = (FloatingActionButton) findViewById(R.id.fabShowVideo);
        floatingActionButtonShowText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                try
                {
                    for (int i = 0; i < response.length(); i++)
                    {
                        ...
                        if(contentUrl.equals(""))
                        {
                            ...
                            floatingActionButtonShowText.setVisibility(View.GONE);
                        }
