...
public class OneContentVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        videoPlayer.setUp(contentUrl, "", Jzvd.SCREEN_WINDOW_NORMAL);
        ...
        /*String contentImageURL = CONTENT_IMG_URL+contentImage;
    ...
    private void addToBookmark()
    {
        ...
        StringRequest requestPostResponse = new StringRequest(Request.Method.POST, Config.ADD_TO_BOOKMARK_URL + "?api_key=" + Config.API_KEY,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(getApplicationContext(),error+" "+R.string.txt_error,Toast.LENGTH_LONG).show();
                        progressWheelInterpolated.setVisibility(View.GONE);
                    }
                }
        ){
                ...
                try
                {
                    for (int i = 0; i < response.length(); i++)
                    {
                        ...
                        if(contentUrl.equals(""))
                        {
                            ...
                            floatingActionButtonShowVideo.setVisibility(View.GONE);
                        }
