...
<script src="<?php echo base_url()."assets/dashboard/plugins/bootstrap-notify/bootstrap-notify.min.js"; ?>"></script>-->
    ...
    <!-- ChartJs
    <script src="<?php echo base_url()."assets/dashboard/plugins/jquery/jquery.min.js"; ?>plugins/chartjs/Chart.bundle.js"></script>-->
    <!-- Flot Charts Plugin Js -->
    <!--<script src="<?php echo base_url()."assets/dashboard/plugins/flot-charts/jquery.flot.js"; ?>"></script>
    <script src="<?php echo base_url()."assets/dashboard/plugins/flot-charts/jquery.flot.resize.js"; ?>"></script>
    <script src="<?php echo base_url()."assets/dashboard/plugins/flot-charts/jquery.flot.pie.js"; ?>"></script>
    <script src="<?php echo base_url()."assets/dashboard/plugins/flot-charts/jquery.flot.categories.js"; ?>"></script>
    <script src="<?php echo base_url()."assets/dashboard/plugins/flot-charts/jquery.flot.time.js"; ?>"></script>-->
