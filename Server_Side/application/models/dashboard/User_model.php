...
class User_model extends CI_Model {
    ...
    function get_user_content($table, $user_id){
        ...
        $query = $this->db->query("Select $table.*, user_type_table.user_type_title, user_role_table.user_role_title
								FROM $table
    ...
    function get_user_role($table){
        ...
        return $q = $this->db->get($table);*/
        $q = $this->db->query("Select user_role_table.*, user_type_table.*
    ...
    {
        $query = $this->db->query("Select user_table.*, user_type_table.user_type_title, user_role_table.user_role_title
								FROM user_table
								INNER JOIN user_type_table
    ...
    function users_search($limit,$start,$search,$col,$dir)
    {
        ...
        $query = $this->db->query("Select user_table.*, user_type_table.user_type_title, user_role_table.user_role_title
								...
								OR (user_type_title LIKE '%$search%') OR (user_role_title LIKE '%$search%')) 
								ORDER BY $col $dir 
								LIMIT $start, $limit;");
