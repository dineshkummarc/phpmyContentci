    ...
    <ul class="list">
        ...
        <li class="<?php if ($last_segment == "push_notification") echo $active_menu; ?>">
            <a href="<?php echo base_url()."dashboard/Settings/push_notification"; ?>">
                ...
                <span><?php echo $this->lang->line("Push Notification"); ?></span>
            </a>
        </li>
        ...
        <!-- User Manual -->
        <li class="">
            <a target="_blank" href="http://www.inw24.com/user_manual/multi_content_app/">
                <i class="material-icons">live_help</i>
                <span>Online User's Manual</span>
            </a>
        </li>
